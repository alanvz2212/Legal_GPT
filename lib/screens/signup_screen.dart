...
// import 'package:legalgpt/screens/home_screen.dart';
import 'package:legalgpt/widgets/custom_scaffold.dart';
import 'package:icons_plus/icons_plus.dart';
// import 'package:legalgpt/screens/signin_screen.dart';
import 'package:legalgpt/theme/theme.dart';
    ...
    if (_formSignupKey.currentState!.validate() && agreePersonalData) {
      try {
        ...
        if (response.user != null) {
          ...
          _showCustomSnackBar(
            'Confirmation mail has been sent to your inbox',
            Colors.green,
          );
          // Navigator.pushReplacement(
          //   context,
  ...
  void _showCustomSnackBar(String message, Color color) {
    final snackBar = SnackBar(
      ...
      margin: const EdgeInsets.all(
        10.0,
      ), // Add margin to separate it from the screen edges
